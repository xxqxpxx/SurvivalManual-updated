    ...
    Scaffold(
        ...
        Box(
            ...
            when {
                ...
                error != null -> Text("Error loading image: ${error.message}", color = MaterialTheme.colors.error)
                imageUrl != null -> {
                ...
                else -> Text("Image not available") // Handle case where imageUrl is null after loading
            }
        }
    }
}